...
SWEP.WorldModel					= "models/ma85_mw3/g18/worldmodel.mdl"
SWEP.HoldType 					= "pistol"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-13.5,-1,2.2)
...
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/g18/fire.wav"}
