...
SWEP.WorldModel					= "models/ma85_mw3/scar/worldmodel.mdl"
SWEP.HoldType 					= "ar2"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-16,-1,3.5)

SWEP.NPC_NextPrimaryFire = 0.12
SWEP.NPC_CustomSpread = 2

SWEP.Primary.Damage				= 5
SWEP.Primary.Force				= 2
SWEP.Primary.ClipSize			= 20
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/scar/fire.wav"}
