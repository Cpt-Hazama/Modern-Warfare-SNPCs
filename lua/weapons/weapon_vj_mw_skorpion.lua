...
SWEP.WorldModel					= "models/ma85_mw3/Skorpion/worldmodel.mdl"
SWEP.HoldType 					= "smg"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-14,-1,3.8)
...
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/Skorpion/fire.wav"}
