...
SWEP.WorldModel					= "models/ma85_mw3/mk46/worldmodel.mdl"
SWEP.HoldType 					= "ar2"
SWEP.MW_JuggernautOverride      = true

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-14.5,-1,3.2)
SWEP.WorldModel_CustomPositionAngle_Juggernaut = Vector(0,90,180)
SWEP.WorldModel_CustomPositionOrigin_Juggernaut = Vector(-14.5,-1,3.2)
...
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/mk46/fire.wav"}
