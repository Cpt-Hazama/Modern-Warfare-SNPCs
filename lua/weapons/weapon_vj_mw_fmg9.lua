...
SWEP.WorldModel					= "models/ma85_mw3/fmg9/worldmodel.mdl"
SWEP.HoldType 					= "smg"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-13.5,-1,3.2)

SWEP.NPC_NextPrimaryFire = 0.05
SWEP.NPC_CustomSpread = 2

SWEP.Primary.Damage				= 4
SWEP.Primary.Force				= 2
SWEP.Primary.ClipSize			= 30
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/fmg9/fire.wav"}
