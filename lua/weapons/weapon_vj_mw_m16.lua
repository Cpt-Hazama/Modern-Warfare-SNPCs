...
SWEP.WorldModel					= "models/ma85_mw3/m16/worldmodel.mdl"
SWEP.HoldType 					= "ar2"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-15,-1,3.5)
...
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/m16/fire.wav"}
