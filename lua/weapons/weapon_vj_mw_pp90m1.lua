...
SWEP.WorldModel					= "models/ma85_mw3/pp90m1/worldmodel.mdl"
SWEP.HoldType 					= "ar2"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-15,-1.4,3.2)
...
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/pp90m1/fire.wav"}
