...
SWEP.WorldModel					= "models/ma85_mw3/smaw/worldmodel.mdl"
SWEP.HoldType 					= "rpg"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-13.5,-1,3.5)
...
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/smaw/fire.wav"}
