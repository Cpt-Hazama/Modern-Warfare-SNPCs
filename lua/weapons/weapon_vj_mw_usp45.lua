...
SWEP.WorldModel					= "models/ma85_mw3/USP45/worldmodel.mdl"
SWEP.HoldType 					= "pistol"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(0,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-14,-1,3.5)
...
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/USP45/fire.wav"}
