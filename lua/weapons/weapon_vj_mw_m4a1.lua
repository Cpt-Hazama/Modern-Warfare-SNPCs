...
SWEP.WorldModel					= "models/ma85_mw3/M4A1/worldmodel.mdl"
SWEP.HoldType 					= "ar2"
...
SWEP.NPC_NextPrimaryFire = 0.095
SWEP.NPC_CustomSpread = 1.9

SWEP.Primary.Damage				= 5
SWEP.Primary.Force				= 2
SWEP.Primary.ClipSize			= 30
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/M4A1/fire.wav"}
