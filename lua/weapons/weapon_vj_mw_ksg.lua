...
SWEP.WorldModel					= "models/ma85_mw3/ksg/worldmodel.mdl"
SWEP.HoldType 					= "ar2"
...
SWEP.NPC_ExtraFireSound = {"cpthazama/mw/weapons/weapons/ksg/close.wav"}
...
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/ksg/fire.wav"}
