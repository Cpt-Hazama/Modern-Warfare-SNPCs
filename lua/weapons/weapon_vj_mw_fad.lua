...
SWEP.WorldModel					= "models/ma85_mw3/fad/worldmodel.mdl"
SWEP.HoldType 					= "ar2"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-14,-1,2.5)

SWEP.NPC_NextPrimaryFire = 0.11
SWEP.NPC_CustomSpread = 2.1

SWEP.Primary.Damage				= 4
SWEP.Primary.Force				= 2
SWEP.Primary.ClipSize			= 30
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/fad/fire.wav"}
