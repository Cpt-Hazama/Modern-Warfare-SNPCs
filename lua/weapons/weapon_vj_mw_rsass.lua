...
SWEP.WorldModel					= "models/ma85_mw3/RSASS/worldmodel.mdl"
SWEP.HoldType 					= "ar2"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-15.5,-1,3.8)

SWEP.NPC_NextPrimaryFire = 0.3
SWEP.NPC_CustomSpread = 0.96
SWEP.NPC_FiringDistanceScale = 2

SWEP.Primary.Damage				= 35
SWEP.Primary.Force				= 2
SWEP.Primary.ClipSize			= 20
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/RSASS/fire.wav"}
