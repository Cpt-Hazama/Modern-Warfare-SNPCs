...
SWEP.WorldModel					= "models/ma85_mw3/mp5/worldmodel.mdl"
SWEP.HoldType 					= "ar2"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-14.5,-1,3.4)
...
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/mp5/fire.wav"}
