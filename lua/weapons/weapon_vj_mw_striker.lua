...
SWEP.WorldModel					= "models/ma85_mw3/striker/worldmodel.mdl"
SWEP.HoldType 					= "smg"

SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(-10,90,180)
SWEP.WorldModel_CustomPositionOrigin = Vector(-16,-1,3.7)
...
SWEP.Primary.Sound				= {"cpthazama/mw/weapons/weapons/striker/fire.wav"}
