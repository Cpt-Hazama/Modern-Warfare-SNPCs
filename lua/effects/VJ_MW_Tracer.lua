...
function EFFECT:Render()
	...
	if self.ShouldDrawSmoke then
		...
		render.DrawBeam(self.StartPos,self.EndPos,(v *Width),0,self.Dist /10,Color(20,20,20,v *135))
		render.SetMaterial(Tracer3)
		render.DrawBeam(self.StartPos,self.EndPos,(v *Width3),0,self.Dist /10,Color(255,255,255,v *135))
	end
